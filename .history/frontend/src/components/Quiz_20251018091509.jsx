...
const Quiz = ({ set, navigateToDashboard, apiCall }) => {
    ...
    // Logic to check for finish state
    useEffect(() => {
    ...
    if (quizFinished) {
        ...
        return (
            <div style={{ padding: '40px', textAlign: 'center' }}>
                ...
                {/* Exit Button - using the styled class */}
                <button 
    ...
    const handleResponse = (isCorrect) => {
        ...
        // 1. Immediately unflip the card (state change)
        setIsFlipped(false);
        
        // 2. Wait 800ms (to match the flip animation in CSS) before advancing to the next card
        setTimeout(() => {
    ...
    return (
        <div style={{ textAlign: 'center', padding: '20px' }}>
            ...
            {/* NEW: Vibrant Progress Indicator (using new CSS class) */}

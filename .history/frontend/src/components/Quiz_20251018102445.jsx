...
const Quiz = ({ set, navigateToDashboard, apiCall }) => {
    ...
    useEffect(() => {
        // Only reset if the original set changes, otherwise keep the redo set if one exists
    ...
    // Function to handle redoing the quiz with only incorrect cards
    ...
    const handleResponse = (isCorrect) => {
        ...
        if (!isCorrect) {
            // Only add the card if it's not already in the list (important for redo sessions)

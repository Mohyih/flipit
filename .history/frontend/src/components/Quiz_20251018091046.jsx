...
const Quiz = ({ set, navigateToDashboard, apiCall }) => {
    ...
    useEffect(() => {
        ...
        // Fix for the answer flash issue
        setIsFlipped(false); 
    ...
    if (quizFinished) {
        ...
        return (
            <div style={{ padding: '40px', textAlign: 'center' }}>
                ...
                {/* Exit Button - Reusing the styled class */}
                <button 
    ...
    const handleResponse = (isCorrect) => {
        ...
        // NEW: Track the index of the incorrect card in the current activeCards list
        if (!isCorrect) {
            setIncorrectCardIndexes(prev => [...prev, currentIndex]);
        }
        
        // Immediate fix: Unflip the card instantly
        setIsFlipped(false);
        
        // Wait for the animation (0.8s for better user experience) to complete, then change content
        setTimeout(() => {
    ...
    return (
        <div style={{ textAlign: 'center', padding: '20px' }}>
            ...
            {/* NEW: Vibrant Progress Indicator */}

// src/components/Quiz.jsx (CORRECTED)
...
const Quiz = ({ set, navigateToDashboard, apiCall }) => {
    ...
    // 🚩 CRITICAL FIX: Ensure the card exists before attempting to render it.
    // If the setTimeout has incremented the index, but the useEffect hasn't run yet,
    // currentCard will be undefined. This prevents the crash/blank screen.
    if (!currentCard) {
    ...
    const handleResponse = (isCorrect) => {
        ...
        setTimeout(() => {
            // This increments the index, triggering the "Quiz Complete" flow on the next render cycle.

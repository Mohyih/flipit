// src/components/SetEditor.jsx (Updated with refreshDashboard prop)

import React, { useState } from 'react';

// Added refreshDashboard to the props
const SetEditor = ({ apiCall, set, refreshSet, navigateToDashboard, refreshDashboard }) => { 
   ...
   const handleDeleteCard = async (cardId) => {
    ...
    const handleSaveTitle = async (e) => {
        ...
        try {
            if (isNewSet) {
                ...
                // 🛑 CRITICAL FIX 1: Refresh the Dashboard data after creating a new set
                if (refreshDashboard) {
                ...
                // The refreshSet() updates the set object in this component's props
                await refreshSet(); 
                
                // 🛑 CRITICAL FIX 2: Refresh the Dashboard data after updating an existing set
                if (refreshDashboard) {
                    await refreshDashboard();
                }
    ...
    return (
        <div className="set-editor">
            ...
            {/* Set Title & Description Form (UPDATED) */}
                                ...
                                <tr key={card.card_id}>
                                    ...
                                    <td>
                                        {editingCardId === card.card_id ? (
                                            ...
                                            <>
                                                {/* EDIT Icon Button (Gear) - Using Material Symbols */}
                                                <button 
                                                ...
                                                {/* DELETE Icon Button (X) - Using Material Symbols */}
                                                <button 

            ...
            <div className="quiz-completion-container">
                ...
                <p style={{ 
                    ...
                    <strong 
                        ...
                        style={{ 
                            display: 'inline-block', // Crucial for truncation on inline element
                            maxWidth: '300px',      // Limit the width of the title
                            verticalAlign: 'middle' // Helps align with surrounding text
                        }}
                    >
                        {set.title}
                    </strong>.

...
const Dashboard = ({ apiCall, navigateToEditor, navigateToQuiz, user, sets, setSets, onCreateSet }) => {
    ...
    return (
        <div className="dashboard">
            ...
            {loading ? (
                ...
                <p>
                    You haven't created any sets yet. Use the <b>+ Create Set</b> button above!
                </p>
            ) : (
